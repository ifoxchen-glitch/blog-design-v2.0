    ...
    render: (row) => h(NSpace, { size: 4 }, { default: () => [
      ...
      permissionStore.hasPermission('iot:manage')
        ? h(NPopconfirm, { onPositiveClick: () => handleToggle(row) }, {
            trigger: () => h(NButton, { size: 'tiny', quaternary: true, type: row.gprsState === '1' ? 'error' : 'success' }, () => row.gprsState === '1' ? h(PowerOutline, { style: { width: '14px', height: '14px' } }) : h(ReplayOutline, { style: { width: '14px', height: '14px' } })),
